...
Flags:
  --config string      Path to configuration file (default: $HOME/.ralphio.json)
...
```sh
cp assets/config.default.json ~/.ralphio.json
```
...
| `app.name` | string | `"ralphio"` | Shown in every screen's header badge |
