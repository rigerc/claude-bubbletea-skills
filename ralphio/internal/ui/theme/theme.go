...
type Theme struct {
	...
	// Status badge styles for task and loop state rendering.
...
func New(isDark bool) Theme {
	...
	return Theme{
		...
		// Status badge styles
		StatusRunning:  lipgloss.NewStyle().Foreground(p.StatusRunning).Bold(true),
		StatusPaused:   lipgloss.NewStyle().Foreground(p.StatusPaused).Bold(true),
		StatusFailed:   lipgloss.NewStyle().Foreground(p.StatusFailed).Bold(true),
		StatusComplete: lipgloss.NewStyle().Foreground(p.StatusComplete).Bold(true),
