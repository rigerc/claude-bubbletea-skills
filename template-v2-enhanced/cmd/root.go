...
var rootCmd = &cobra.Command{
	Use:   "template-v2-enhanced",
	Short: "A production-ready BubbleTea v2 template",
	Long: `template-v2-enhanced is a comprehensive scaffold for building terminal
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "",
		"Path to configuration file (default: $HOME/.template-v2-enhanced.json)")
